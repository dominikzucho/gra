...
$rezultat = @$polaczenie->query("SELECT * FROM `gracz` WHERE ID = '$id'");
    ...
    $rezultat = @$polaczenie->query("SELECT * FROM `gracz` WHERE ID = '$id'");
    $_SESSION['zelazoPlus'] = $rezultat->fetch_assoc()['zelazoPlus'];
    $rezultat->free_result();
    $zelazoPlus = $_SESSION['zelazoPlus'];
